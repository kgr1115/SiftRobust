...
class GroqProvider(_OpenAICompatProvider):
    ...
    pricing = {
        ...
        # mixtral-8x7b-32768 was decommissioned by Groq in early 2026 and now
        # returns 400 on any request — not listed here so the settings UI
        # doesn't offer it as a pickable option.
