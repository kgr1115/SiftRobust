...
class GoogleProvider(LLMProvider):
    ...
    pricing = {
        ...
        #
        # Only non-thinking Gemini models are listed. 2.5-pro is excluded
        # because it requires thinking_budget>0 and our shared structured_call
        # path hard-codes thinking_budget=0 for apples-to-apples latency with
        # non-thinking peers. The 2.0-* models were retired on Google's side
        # (404 on real API calls as of early 2026).
